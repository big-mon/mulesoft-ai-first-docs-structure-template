...
このREADMEは探索用の案内であり、Application、API、Operationの正本ではありません。リポジトリに存在するApplication一覧は、ルートの `../design-index.yaml` を参照してください。
...
- `../design-index.yaml` に未登録のApplicationを設計対象として扱わないでください。
