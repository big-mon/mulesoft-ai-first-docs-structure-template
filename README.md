...
5. `applications/{appId}/docs/application-basic-design.md`
6. 関連するAPI root RAML
7. 関連するOperation RAML fragment
8. `applications/{appId}/docs/application-detail-design.md`
...
| 基本設計上の判断 | `applications/{appId}/docs/application-basic-design.md` |
| Flow / Processor / Error Handler設計 | `applications/{appId}/docs/application-detail-design.md` |
...
| 基本設計 | `applications/{appId}/docs/application-basic-design.md`, `applications/{appId}/apis/**`, `applications/{appId}/design-index.yaml` | API契約、責務、API管理、シーケンス、エラー方針を定義する |
| 詳細設計 | `applications/{appId}/docs/application-detail-design.md`, `applications/{appId}/design-index.yaml` | Mule Flow、Processor、Connector、DataWeave、Error Handler、MUnit観点を定義する |
